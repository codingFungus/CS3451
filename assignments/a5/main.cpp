...
public:
    ...
    {
        Create_Background(OpenGLColor(0.7f, 0.5f, 0.7f, 1.f), OpenGLColor(0.7f, 0.5f, .7f, 1.f));   //// add background
        ...
        auto pomegranate = Add_Obj_Mesh_Object("PomegranateScan_OBJ/pomegranate.obj");
        ...
        //// initialize transform
            ...
            t << 3, 0, 0, 1,
                ...
                0, 0, 3, 0,
                0, 0, 0, 1;
            pomegranate->Set_Model_Matrix(t);

            //// initialize material
            pomegranate->Set_Ka(Vector3f(0.1, 0.1, 0.1));
            pomegranate->Set_Kd(Vector3f(0.7, 0.7, 0.7));
            pomegranate->Set_Ks(Vector3f(2., 2., 2.));
            pomegranate->Set_Shininess(128.);

            //// initialize texture
            Add_Textture_For_Mesh_Object(pomegranate, "PomegranateScan_OBJ/textures/1024/Pomegranate_BaseColor.png", TexType::Color);
            Add_Textture_For_Mesh_Object(pomegranate, "PomegranateScan_OBJ/textures/1024/Pomegranate_NormalDirectX.png", TexType::Normal);
